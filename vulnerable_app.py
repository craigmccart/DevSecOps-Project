...
This file contains intentionally vulnerable code for educational and demonstration purposes.
It showcases common security vulnerabilities as defined by OWASP Top 10.
DO NOT use this code in production environments or for any real applications.
This is strictly for security training and DevSecOps pipeline demonstration.
"""
...
if __name__ == '__main__':
    ...
    # FAKE_API_KEY removed for security demonstration purposes